...
export const MkTree = defineComponent({
  ...
  props: {
    ...
    loadData: { type: Function as () => TreeOptions['loadData'], default: undefined },
  },
  ...
  setup(props, { emit }) {
    ...
    watch(() => [props.data, props.showCheckbox, props.checkStrictly, props.lazy, props.filter], () => nextTick(create), { deep: true })
